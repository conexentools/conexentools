...
class UserPreferencesImpl @Inject constructor(
  ...
  override suspend fun saveCardToUseDropDownMenuPosition(value: String?) = save(PK.CARD_TO_USE_DROP_DOWN_MENU_POSITION, value)
  ...
  override val cardToUseDropDownMenuPosition: Flow<String?> get() = load(PK.CARD_TO_USE_DROP_DOWN_MENU_POSITION)
